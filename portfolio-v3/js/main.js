/* Portfolio V3 · Beatrice Perrone
   Interazioni: lingua IT/EN, nav, reveal, text reveal, cursor glow, touch flip */
...
(function () {
  ...
  // ---- text reveal (hero) ----
  var ttLines = document.querySelectorAll(".tt-line");
  ttLines.forEach(function (line, i) {
    setTimeout(function () { line.classList.add("in"); }, 120 + i * 140);
  });
  ...
  if (window.matchMedia("(prefers-reduced-motion: reduce)").matches) {
    revealEls.forEach(function (el) { el.classList.add("in"); });
    ttLines.forEach(function (line) { line.classList.add("in"); });
  }

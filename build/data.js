...
const SITE = {
  ...
  intro: "Ciao, sono Beatrice. Mi occupo di eventi e marketing: coordino eventi culturali e live end-to-end — dal concept alla logistica, dall'ospitalità al pubblico — e sviluppo strategie di comunicazione capaci di generare engagement, visibilità e affluenza.",
...
const PROJECTS = [
  ...
  },
  {
    ...
    abstract:
      "Concerti alle 6–7 del mattino: un format fuori dagli schemi che richiede accoglienza a orari inconsueti e una logistica pensata per trasformare l'alba in un'esperienza unica.",
    hero: {
